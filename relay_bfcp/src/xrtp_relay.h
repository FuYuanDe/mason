...
#define log_info(fmt, arg...)   printk(KERN_INFO"%s:%d " fmt, __FUNCTION__ , __LINE__, ##arg)
#define log_warn(fmt, arg...)   printk(KERN_WARNING"%s:%d " fmt, __FUNCTION__ , __LINE__, ##arg)
