...
struct capture_info {
    unsigned int taskid;
    unsigned int localflag;            /* remote server or local */
    unsigned int islocalpkt;           /* is local packet needed */
...
struct capture_task_info_nl {
    unsigned int taskid;                /* task id                      */
    unsigned int localflag;             /* 0: local server, 1: rmote server */
    unsigned int timerval;              /* task timeval                 */
    unsigned int islocalpkt;            /* 1,: not capture interprocess packet, 0: capture local packet        */
